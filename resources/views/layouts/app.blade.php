...
<div class="main">
    ...
    {{--  <div class="row">
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    <img src="img/bc7.jpg" class="card-img-top mb-4">
                    <h3 class="card-title">Title image</h3>
                    <p class="card-subtitle">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Earum maiores minima omnis consectetur inventore sapiente dicta</p>
                </div>
                <div class="text-center mb-2">
                    <button class="btn btn-success">Okey,Go</button>
                </div>
            </div>
        </div>
        <div class="col-md-6">
